...
function sendToWhatsApp() {
  ...
  const teksPesan = `Halo Soleria Gift, saya ingin mengirim formulir penawaran.%0A%0A` +
...
function sendToWhatsAppService() {
  ...
  const teksPesan = `Halo Soleria Gift, saya ingin mendapatkan penawaran desain.%0A%0A` +
                    `*Nama:* ${encodeURIComponent(name)}%0A` +
                    `*Email:* ${encodeURIComponent(email)}%0A` +
...
function sendToWhatsAppBox() {
  ...
  const teksPesan = `Halo Soleria Gift, saya ingin menanyakan penawaran Desain Kotak Eksklusif.%0A%0A` +
                    `*Nama:* ${encodeURIComponent(name)}%0A` +
                    `*Email:* ${encodeURIComponent(email)}%0A` +
                    `*Nomor Telepon:* ${encodeURIComponent(phone)}%0A` +
                    `*Subjek:* ${encodeURIComponent(subject)}%0A` +
...
function sendToWhatsAppWelcome() {
  ...
  const teksPesan = `Halo Soleria Gift, saya ingin menanyakan estimasi harga Welcoming Kit Korporat.%0A%0A` +
                    `*Nama:* ${encodeURIComponent(name)}%0A` +
                    `*Email:* ${encodeURIComponent(email)}%0A` +
                    `*Nomor Telepon:* ${encodeURIComponent(phone)}%0A` +
                    `*Subjek:* ${encodeURIComponent(subject)}%0A` +
...
function sendToWhatsAppSeminar() {
  ...
  const teksPesan = `Halo Soleria Gift, saya ingin mengajukan penawaran Seminar Kit.%0A%0A` +
...
function sendToWhatsAppMerch() {
  ...
  const teksPesan = `Halo Soleria Gift, saya ingin mengajukan penawaran Merchandise Acara.%0A%0A` +
                    `*Nama / Instansi:* ${encodeURIComponent(name)}%0A` +
                    `*Email:* ${encodeURIComponent(email)}%0A` +
                    `*Nomor Telepon:* ${encodeURIComponent(phone)}%0A` +
                    `*Subjek:* ${encodeURIComponent(subject)}%0A` +
...
function sendToWhatsAppPremium() {
  ...
  // Susun struktur teks pesan WhatsApp yang rapi
  const teksPesan = `Halo Soleria Gift, saya ingin mengajukan penawaran Premium Corporate Gift.%0A%0A` +
                    `*Nama / Instansi:* ${encodeURIComponent(name)}%0A` +
                    `*Email:* ${encodeURIComponent(email)}%0A` +
                    `*Nomor Telepon:* ${encodeURIComponent(phone)}%0A` +
                    `*Subjek:* ${encodeURIComponent(subject)}%0A` +
